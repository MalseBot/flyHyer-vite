...
import { hyerNews,paperNews,backplane,freitas,manWithWatch,pilatus,xa5o,gruopCharter } from '../assets'
...
const News = () => {
  ...
  return (
    <div>
      <div className='relative w-full md:h-screen h-auto mb-10 '>
        ...
        <div className='grid md:grid-cols-7 relative z-10 text-second gap-14 md:gap-0 md:grid-rows-6 md:p-10 md:h-screen h-max'>
          ...
          <div className='md:col-start-5 md:col-span-2 md:row-start-3'>
            <h2 className=' text-4xl my-4'>What's New?</h2>
            <p className=' text-xl'>
      ...
      <div className='grid md:grid-rows-3 md:mx-20 mx-10 md:grid-cols-3 grid-cols-1 gap-10'>
        <button className=' flex flex-col py-16 h-screen items-center'>
          <img
            src={paperNews}
            className='w-full h-full object-cover shadow-2xl'
            alt=''
          />
          <p className=' text-main text-opacity-50'>21/7/2023</p>
          <h3 className=' text-2xl font-bold text-main'>Hyer In The News</h3>
        </button>
        <button className=' flex flex-col py-16 h-screen items-center'>
          <img
            src={backplane}
            ...
            alt=''
          />
          <p className=' text-main text-opacity-50'>04/7/2023</p>
          <h3 className=' text-2xl font-bold text-main'>
            Electric powered private jets. Anytime soon?
          </h3>
        </button>
        <button className=' flex flex-col py-16 h-screen items-center'>
          <img
            ...
            alt=''
          />
          <p className=' text-main text-opacity-50'>04/5/2023</p>
          <h3 className=' text-2xl font-bold text-main'>
        ...
        <button className=' flex flex-col py-16 h-screen items-center'>
          <img
            ...
            alt=''
          />
          <p className=' text-main text-opacity-50'>16/4/2023</p>
          <h3 className=' text-2xl font-bold text-main'>
        ...
        <button className=' flex flex-col py-16 h-screen items-center'>
          <img
            ...
            alt=''
          />
          <p className=' text-main text-opacity-50'>29/3/2023</p>
          <h3 className=' text-2xl font-bold text-main'>Flying private with a large gruop What to expect?</h3>
        </button>
        <button className=' flex flex-col py-16 h-screen items-center'>
          <img
            src={xa5o}
            ...
            alt=''
          />
          <p className=' text-main text-opacity-50'>16/3/2023</p>
          <h3 className=' text-2xl font-bold text-main'>Flying with pets on private jets</h3>
        </button>
        <button className=' flex flex-col py-16 h-screen items-center'>
          <img
            src={manWithWatch}
            ...
            alt=''
          />
          <p className=' text-main text-opacity-50'>26/1/2023</p>
          <h3 className=' text-2xl font-bold text-main'>How much time do you save when flying private?</h3>
        </button>
      </div>
    </div>
  )
